# n8n_export.py
# Exports last 24 hours of clean jobs as JSON to stdout.
# n8n reads this and writes to Google Sheets.
...
def _fmt_date(raw: str) -> str:
    """Convert YYYY-MM-DD or YYYY-MM-DD HH:MM to readable format."""
    if not raw:
        return ""
